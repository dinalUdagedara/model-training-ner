...
3. **Write first:** Ch 7 → 8 → 9 → 10 → Abstract; then update Ch 4–6 and Ch 1–3 to match the built system. **Ch 8:** [plan](./chapter-08-testing-PLAN.md) · [draft](./chapter-08-testing-DRAFT.md).
...
| **Sample “good” FYP (reference only)** | [`../sample-project/Pansilu_Ashinshana_Wijesiri_w19127880_20210021_FPR.pdf`](../sample-project/Pansilu_Ashinshana_Wijesiri_w19127880_20210021_FPR.pdf) |
